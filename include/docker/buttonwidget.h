...
//  void setIconSize(const QSize& iconSize);
  ...
  //! Returns the Docker::arrangement of the text/icon combination.
  Docker::Arrangement arrangement();
  /*!
   ...
   */
  void setArrangement(Docker::Arrangement arrangement);
  ...
  //! Painter function for ButtonWidget.
