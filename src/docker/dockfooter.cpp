...
DockFooterPrivate::DockFooterPrivate(AbstractDockWidget* parent,
                                     AbstractDockItem* item)
  : AbstractDockItemPrivate(Docker::South, parent, item)
{
  setPreferredSize(WIDTH, HEIGHT);
}

WidgetItem*
DockFooterPrivate::addListWidget(Docker::WidgetPosition pos, const QString& tooltip)
{
...
ButtonWidget*
DockFooter::addIconButton(Docker::WidgetPosition pos,
                                QPixmap pixmap,
...
ButtonWidget*
DockFooter::addDragIconButton(Docker::WidgetPosition pos,
                                    QPixmap pixmap,
                                    const QString& tooltip)
{
  Q_D(AbstractDockItem);
...
ButtonWidget*
DockFooter::addIconListButton(Docker::WidgetPosition pos,
                                    QPixmap pixmap,
                                    const QString& tooltip)
{
...
ButtonWidget*
DockFooter::addIconTextButton(Docker::WidgetPosition pos,
                                    QPixmap pixmap,
                                    const QString& text,
...
ButtonWidget*
DockFooter::addIconTextListButton(Docker::WidgetPosition pos,
                                        QPixmap pixmap,
                                        const QString& text,
                                        Docker::Arrangement textPos,
                                        const QString& tooltip)
...
ButtonWidget*
DockFooter::addTextButton(Docker::WidgetPosition pos,
                                const QString& text,
                                const QString& tooltip)
{
...
ButtonWidget*
DockFooter::addTextListButton(Docker::WidgetPosition pos,
                                    const QString& text,
                                    const QString& tooltip)
{
...
WidgetItem*
DockFooter::addTextLabel(Docker::WidgetPosition pos,
                               const QString& text,
                               const QString& tooltip)
{
...
WidgetItem*
DockFooter::addSeperator(Docker::WidgetPosition pos)
{
...
WidgetItem*
DockFooter::addListWidget(Docker::WidgetPosition pos, const QString& tooltip)
{
  Q_D(DockFooter);
